...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "LIBRARY_EX_2015_USER"."SEQ_authors_a_id"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_books_b_id
--------------------------------------------------------

   CREATE SEQUENCE  "LIBRARY_EX_2015_USER"."SEQ_books_b_id"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 8 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_genres_g_id
--------------------------------------------------------

   CREATE SEQUENCE  "LIBRARY_EX_2015_USER"."SEQ_genres_g_id"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 7 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_subscribers_s_id
--------------------------------------------------------

   CREATE SEQUENCE  "LIBRARY_EX_2015_USER"."SEQ_subscribers_s_id"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 5 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence SEQ_subscriptions_sb_id
--------------------------------------------------------

   CREATE SEQUENCE  "LIBRARY_EX_2015_USER"."SEQ_subscriptions_sb_id"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 101 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (1,'Д. Кнут');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (2,'А. Азимов');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (3,'Д. Карнеги');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (4,'Л.Д. Ландау');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (5,'Е.М. Лифшиц');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (6,'Б. Страуструп');
Insert into LIBRARY_EX_2015_USER."authors" ("a_id","a_name") values (7,'А.С. Пушкин');
REM INSERTING into LIBRARY_EX_2015_USER."books"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (1,'Евгений Онегин',1985,2);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (2,'Сказка о рыбаке и рыбке',1990,3);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (3,'Основание и империя',2000,5);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (4,'Психология программирования',1998,1);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (5,'Язык программирования С++',1996,3);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (6,'Курс теоретической физики',1981,12);
Insert into LIBRARY_EX_2015_USER."books" ("b_id","b_name","b_year","b_quantity") values (7,'Искусство программирования',1993,7);
REM INSERTING into LIBRARY_EX_2015_USER."genres"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (5,'Классика');
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (4,'Наука');
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (1,'Поэзия');
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (2,'Программирование');
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (3,'Психология');
Insert into LIBRARY_EX_2015_USER."genres" ("g_id","g_name") values (6,'Фантастика');
REM INSERTING into LIBRARY_EX_2015_USER."m2m_books_authors"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (1,7);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (2,7);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (3,2);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (4,3);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (4,6);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (5,6);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (6,4);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (6,5);
Insert into LIBRARY_EX_2015_USER."m2m_books_authors" ("b_id","a_id") values (7,1);
REM INSERTING into LIBRARY_EX_2015_USER."m2m_books_genres"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (1,1);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (1,5);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (2,1);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (2,5);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (3,6);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (4,2);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (4,3);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (5,2);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (6,5);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (7,2);
Insert into LIBRARY_EX_2015_USER."m2m_books_genres" ("b_id","g_id") values (7,5);
REM INSERTING into LIBRARY_EX_2015_USER."subscribers"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."subscribers" ("s_id","s_name") values (1,'Иванов И.И.');
Insert into LIBRARY_EX_2015_USER."subscribers" ("s_id","s_name") values (2,'Петров П.П.');
Insert into LIBRARY_EX_2015_USER."subscribers" ("s_id","s_name") values (3,'Сидоров С.С.');
Insert into LIBRARY_EX_2015_USER."subscribers" ("s_id","s_name") values (4,'Сидоров С.С.');
REM INSERTING into LIBRARY_EX_2015_USER."subscriptions"
SET DEFINE OFF;
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (100,1,3,to_date('12-JAN-11','DD-MON-RR'),to_date('12-FEB-11','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (2,1,1,to_date('12-JAN-11','DD-MON-RR'),to_date('12-FEB-11','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (3,3,3,to_date('17-MAY-12','DD-MON-RR'),to_date('17-JUL-12','DD-MON-RR'),'Y');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (42,1,2,to_date('11-JUN-12','DD-MON-RR'),to_date('11-AUG-12','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (57,4,5,to_date('11-JUN-12','DD-MON-RR'),to_date('11-AUG-12','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (61,1,7,to_date('03-AUG-14','DD-MON-RR'),to_date('03-OCT-14','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (62,3,5,to_date('03-AUG-14','DD-MON-RR'),to_date('03-OCT-14','DD-MON-RR'),'Y');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (86,3,1,to_date('03-AUG-14','DD-MON-RR'),to_date('03-SEP-14','DD-MON-RR'),'Y');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (91,4,1,to_date('07-OCT-15','DD-MON-RR'),to_date('07-MAR-15','DD-MON-RR'),'Y');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (95,1,4,to_date('07-OCT-15','DD-MON-RR'),to_date('07-NOV-15','DD-MON-RR'),'N');
Insert into LIBRARY_EX_2015_USER."subscriptions" ("sb_id","sb_subscriber","sb_book","sb_start","sb_finish","sb_is_active") values (99,4,4,to_date('08-OCT-15','DD-MON-RR'),to_date('08-NOV-25','DD-MON-RR'),'Y');
--------------------------------------------------------
